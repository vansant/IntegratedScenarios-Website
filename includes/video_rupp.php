        ...
        <div class="row">
            <div class="col-md-7">
		  <iframe width="100%" height="400" src="http://www.youtube.com/embed/KnG4_Cc_VL8" frameborder="0"></iframe>
            </div>
            <div class="col-md-5">
                <h3>Climate Change Projections for the Northwest</h3>
                <h4>Dr. David Rupp</h4>
                <h5>Oregon Climate Change Research Institute(OCCRI)<br> 
			Oregon State University</h5>
            </div>
        </div>
        <!-- /.row -->
