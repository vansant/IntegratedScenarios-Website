        ...
        <div class="row">
            <div class="col-md-7">
		  <iframe width="100%" height="400" src="http://www.youtube.com/embed/SHcxLmFePLs" frameborder="0"></iframe>
            </div>
            <div class="col-md-5">
                <h3>Climate Change and Ecosystems: Simulating Vegetation and Fire Response for the Western USA</h3>
                <h4>Dr. Dominique Bachelet and Dr. Tim Sheehan</h4>
                <h5>Conservation Biology Institute</h5>
            </div>
        </div>
        <!-- /.row -->
